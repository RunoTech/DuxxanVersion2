    ...
    <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 hover:shadow-2xl transition-all duration-300 group rounded-xl overflow-hidden">
      <CardHeader className="p-0">
        <div className="relative">
          ...
          {/* Gradient Background */}
          <div className="h-52 bg-gradient-to-br from-green-500 via-emerald-500 to-teal-600 rounded-t-xl flex items-center justify-center relative overflow-hidden">
            <div className="absolute inset-0 bg-black/10"></div>
            <div className="relative z-10 text-center">
              <Heart className="w-20 h-20 text-white mb-2 mx-auto" />
              <div className="text-white/90 text-sm font-semibold">HELP NEEDED</div>
            </div>
      ...
      <CardContent className="p-6">
        <div className="mb-4">
          <Link href={`/donations/${donation.id}`}>
            <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 hover:text-green-500 transition-colors duration-200 line-clamp-2 mb-3 group-hover:text-green-500">
              {donation.title}
            </h3>
          </Link>
        ...
        <div className="flex items-center justify-between">
          ...
          <Link href={`/donations/${donation.id}`}>
            <Button className="bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-bold px-6 py-3 rounded-xl shadow-lg transition-all duration-200 transform hover:scale-105">
