      ...
      <div className="space-y-8">
        ...
        <Card className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border-blue-200 dark:border-blue-700">
          <CardHeader>
            ...
            <CardDescription>
              Blockchain tabanlı çekiliş ve bağış platformu nasıl çalışır
            </CardDescription>
          </CardHeader>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-3">
                ...
                <ul className="space-y-2 text-sm text-blue-700 dark:text-blue-300">
                  <li>• Şeffaf ve güvenli çekiliş sistemi</li>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center space-x-2">
              ...
              <span>Çekiliş Sistemi Nasıl Çalışır</span>
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="grid md:grid-cols-3 gap-6">
              <div className="space-y-3">
                ...
                <h4 className="font-semibold">Çekiliş Oluşturma</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Kullanıcılar ödül değeri, bilet fiyatı ve maksimum bilet sayısını belirleyerek çekiliş oluşturur.
                </p>
              </div>
              <div className="space-y-3">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Katılımcılar BNB ile bilet satın alır. Tüm işlemler blockchain üzerinde kayıt altına alınır.
                </p>
              </div>
              <div className="space-y-3">
            ...
            <div className="space-y-4">
              <h4 className="font-semibold text-lg">Çekiliş Kuralları</h4>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <h5 className="font-medium text-green-600 dark:text-green-400">İzin Verilen</h5>
                  <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-400">
                    <li>• Yasal ürün ve hizmet çekilişleri</li>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Card className="bg-green-50 dark:bg-green-900/20 border-green-200 dark:border-green-700">
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-sm">Minimum Çekiliş Tutarı</span>
                    <Badge variant="secondary">0.01 BNB</Badge>
                  </div>
                  <Separator />
              ...
              <Card className="bg-purple-50 dark:bg-purple-900/20 border-purple-200 dark:border-purple-700">
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <Badge variant="secondary">0.001 BNB</Badge>
                  </div>
                  <Separator />
