            ...
            <Card className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-xl rounded-2xl overflow-hidden">
              <CardHeader className="bg-gradient-to-r from-blue-500 to-blue-600 text-white">
                <CardTitle className="text-2xl font-bold flex items-center gap-3">
                  ...
                  Aktif Çekiliş Katılımları
                </CardTitle>
                <p className="text-blue-100">
                  Şu anda katıldığınız ve devam eden çekilişler
                </p>
              </CardHeader>
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  {participations.filter((p: any) => !p.raffle?.isActive).length === 0 && (
                    <div className="text-center py-16">
                      ...
                      <p className="text-gray-500 dark:text-gray-400">
                        Çekilişlere katılarak geçmişinizi oluşturmaya başlayın!
                      </p>
                    </div>
                  )}
                </div>
            ...
            <Card className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-xl rounded-2xl overflow-hidden">
              <CardHeader className="bg-gradient-to-r from-green-500 to-green-600 text-white">
                <CardTitle className="text-2xl font-bold flex items-center gap-3">
                  ...
                  Oluşturduğunuz Çekilişler
                </CardTitle>
                <p className="text-green-100">
                  Platform'da yarattığınız çekiliş deneyimleri
                </p>
              </CardHeader>
              <CardContent className="p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    {createdRaffles.length === 0 && (
                      <div className="text-center py-16">
                        ...
                        <h3 className="text-xl font-semibold text-gray-600 dark:text-gray-400 mb-2">
                          Henüz çekiliş oluşturmadınız
                        </h3>
                        <p className="text-gray-500 dark:text-gray-400 mb-6">
                          İlk çekilişinizi oluşturarak topluluğa katkıda bulunun!
                        </p>
                        <Button 
