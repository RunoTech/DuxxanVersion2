    ...
    <div className="min-h-screen bg-gray-50 dark:bg-duxxan-dark">
      ...
      <section className="bg-gradient-to-br from-gray-100 to-gray-200 dark:duxxan-gradient py-20 relative">
        ...
        <div className="fixed top-6 right-6 z-50">
          <div className="inline-flex items-center bg-duxxan-success/10 backdrop-blur-sm border border-duxxan-success/30 rounded-full px-3 py-2 shadow-lg ml-[220px] mr-[220px] mt-[280px] mb-[280px]">
